...
class Program {
  ...
  async run() {
    ...
    let entry = this.instance.exports['_initialize'];
...
export { worker as BackgroundWorker, process as Process, Program, syscall_entry as SyscallEntry, syscall_handler as SyscallHandler, wasi as WASI, WasiView, util };
